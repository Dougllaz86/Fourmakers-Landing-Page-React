...
Logos1.defaultProps = {
  logo1Alt: 'Logo da plataforma de gestão de pessoas',
  logo4Alt: 'Logo de gamificação',
  logo5Src:
  ...
  logo6Alt: 'Logo de satisfação da equipe',
  logo6Src:
  ...
  logo3Alt: 'Logo de match de competências',
  logo2Src:
  ...
  logo2Alt: 'Logo de alocação inteligente',
  logo1Src:
  ...
  logo5Alt: 'Logo de aumento de produtividade',
  heading1: undefined,
  logo4Src:
